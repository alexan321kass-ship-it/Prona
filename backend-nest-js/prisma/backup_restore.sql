...
INSERT INTO `devolucion` (`id_devolucion`, `fecha_devolucion`, `motivo`, `id_venta`, `id_usuario`) VALUES
(1, '2025-12-01 18:56:40', 'Producto dañado en el transporte', 4, 2),
(2, '2025-12-01 18:56:40', 'Error en cantidad entregada', 2, 2),
(3, '2025-12-01 18:56:40', 'Cliente canceló el pedido antes del envío', 5, 2),
(4, '2025-12-01 18:56:40', 'Retraso en entrega', 6, 2),
(5, '2025-12-01 18:56:40', 'Producto equivocado', 8, 2),
(6, '2025-12-01 18:56:40', 'Empaque defectuoso', 9, 2),
(7, '2025-12-01 18:56:40', 'Cliente devolvió por vencimiento', 3, 2),
(8, '2025-12-01 18:56:40', 'Error en cotización inicial', 1, 2),
(9, '2025-12-01 18:56:40', 'Pedido duplicado', 7, 2),
(10, '2025-12-01 18:56:40', 'Motivo no especificado', 10, 2);
...
(56, '2025-12-17 09:07:31', 'Preparacion', 2, 15),
...
(1, 'Carlos', 'Martínez', 'CC', '10102030', 'carlos.martinez@pronavid.com', 'hashedpass1', 1, 1),
(2, 'Laura', 'Gómez', 'CC', '10203040', 'laura.gomez@pronavid.com', 'hashedpass2', 1, 2),
(3, 'Andrés', 'Pérez', 'CC', '10304050', 'andres.perez@pronavid.com', 'hashedpass3', 1, 2),
(4, 'María', 'Rojas', 'CC', '10405060', 'maria.rojas@pronavid.com', 'hashedpass4', 1, 2),
(5, 'Camilo', 'López', 'CC', '10506070', 'camilo.lopez@pronavid.com', 'hashedpass5', 1, 1),
(6, 'Diana', 'Ramírez', 'CC', '10607080', 'diana.ramirez@pronavid.com', 'hashedpass6', 1, 2),
(7, 'Felipe', 'Torres', 'CC', '10708090', 'felipe.torres@pronavid.com', 'hashedpass7', 1, 2),
(8, 'Natalia', 'Jiménez', 'CC', '10809100', 'natalia.jimenez@pronavid.com', 'hashedpass8', 1, 2),
(9, 'Jorge', 'Suárez', 'CC', '10901020', 'jorge.suarez@pronavid.com', 'hashedpass9', 1, 1),
(10, 'Paula', 'Castro', 'CC', '11002030', 'paula.castro@pronavid.com', 'hashedpass10', 1, 2),
(11, 'nicolas', 'moreno', 'CC', '1029140364', 'a@tester.com', '$2b$10$YEjdJka6p0dWIQKwiRES.OfgDxLT8e4itmNE/iS9mM7xKcB/3gWQK', 1, 2),
(12, 'Nireba', 'deida', 'CC', '1025142638', 'ad@test.com', '$2b$10$VBgZSdvZaVfsGtezaXATI.Bm6xGQdgW46OVsCTcv31D9t2AVeBJmO', 1, 1),
(13, 'juan', 'santos', 'CC', '129283893', 'juan@test.com', '$2b$10$0D4Ot.ug21I4B1wGeGdvAubenhoeFtJiDHAQEfsW/hDD2VivY9Hhe', 1, 2),
(14, 'Jhon', 'Merchan', 'CC', '1033704652', 'a@gmail.com', '$2b$10$2mwoTqURodx2zDDz/7/CYeWw4b9U8B2es5XUcQ9Lvr5AWbB649P3W', 1, 2),
(15, 'Michell', 'Quintero', 'CC', '12345678', 'asd@test.com', '$2b$10$8Y5rIIDdryDfmcI8zYbgeugnwpQzNb/4GnOFuSwS1MyZFW1TdGzyq', 1, 2),
(16, 'Jhon', 'Moreno', 'CC', '987654321', 'e@gmail.com', '$2b$10$qyxl6S5BfwTpG8OBFxCZ0.TMR4RFdAsmbSMq.uPiLsnUXGYRsJ/fi', 1, 1),
(18, 'Fabian', 'Parra', 'CC', '1234567', 'foparra@gmail.com', '$2b$10$6Uh70tMv6ZqW2pAuhZfuauSYTILoXHtWYWtkz68TxgLJcK/lXiSoy', 1, 1),
(19, 'Nireba', 'Moreno', 'CC', '1231231231', 'qwerty@gmail.com', '$2b$10$mfLvcOTy4uFEMUeVv0yJN.f62luMb2FV1RP/.wk.kwFFp6tLQgdGe', 1, 2),
(21, 'Alexxx', 'Merchan', 'CC', '1033704653', 'alexan321kass@gmail.com', '$2b$10$JfRrRyEdV8lEBOywCkOoyOBnnw0ehzXdDLhGm.m9LfyduGCP4oJ5O', 1, 1),
(23, 'viktor', 'marin', 'CC', '1234567888', 'asw@gm.com', '$2b$10$Rzd/F/Ij57ZiE0r45nKGd.nVUwAeLaxz3AiuqOqRrnR5rNU52CxhW', 1, 2),
(24, 'Test7453', 'User', 'CC', '1234567453', 'test7453@example.com', '$2b$10$S2Dbi2YzZrvpErQEYKwfjOh5wX3rWyW5acVzaAqOgY.EbWyuCcQnS', 1, 1),
(25, 'Test9510', 'User', 'CC', '1234569510', 'test9510@example.com', '$2b$10$2DYaEMXPc4EUFZ/TA2GP8.RB7AlvPiz76TiR5eZArdpCxxKtwMmMq', 1, 1),
(27, 'Nicolas', 'Soba', 'CC', '1029140365', 'nicolas220x@gmail.com', '$2b$10$FMzCGfEKBTWewF8wr1hRceaUzNyYbpE1kp4S48rRDejNNN59xfKb.', 1, 2),
(28, 'asd', 'asd', 'CC', '123456789', 'as@as.com', '$2b$10$lwrsn5r4VN8GNULVnCtFYOh8xrJ.naMzO5P4y2hroJ09FcQ/29LPK', 1, 2),
(29, 'ads', 'ads', 'CC', '123123412', 'adso@adso.com', '$2b$10$VSOVELt3QbfKvfvVqVS9L.IRi/ZKOfw5QG11MY.UI87oqbFZPBq66', 1, 1),
(30, 'Test5015', 'User', 'CC', '1234565015', 'test5015@example.com', '$2b$10$KZN6YuOBML9thSslGmlTy.vSOOCTMn2UNMSJltLR.5OmVNmyI5riO', 1, 1),
(31, 'Test4855', 'User', 'CC', '1234564855', 'test4855@example.com', '$2b$10$wv78RvK3sfGECG6p5AiNO.pARgFsDsknt/P07OyPtML7WGQJQO9WO', 1, 1),
(32, 'basxn', 'tico', 'CC', '1234561231', 'basxngod@gmail.com', '$2b$10$3ZTghgGlj4oxOp8eGASfHORX896LuCWjmK6qEUkPVguo375sX1Nki', 1, 2),
(33, 'Test', 'User', 'CC', '55667788', 'test15@example.com', '$2b$10$bX1H2K6rrA2.JlNJ1J0mpeUxQb9X/Sd3FavSJVkMVvg7CSGmgE3w2', 1, 2),
(34, 'basan', 'chan', 'CE', '1234561233', 'basxn@bsx.com', '$2b$10$uRjuec2lW77BGWhPgrwFJ.Twel5FwSHBAeq3gWs./k9sDq.QNHCgC', 1, 2),
(35, 'basxnn', 'tote', 'CC', '1234567123', 'basxn@basxn.com', '$2b$10$akHehiSoFVamTyJWTgRjWeZZuuJzXNgovvJSz8uduGJIF//3MvkbO', 1, 2),
(36, 'samuel', 'fernandez', 'TI', '1231231234', 'samu@fer.com', '$2b$10$irSbMJxA3/vHXqFOgGbPs.T4T.30xj17Y951ntJnpzxH.0uhZ6XZ2', 1, 2),
